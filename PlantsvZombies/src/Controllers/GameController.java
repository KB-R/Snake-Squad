...
public class GameController implements Runnable{
     ...
     */
    public Boolean checkEndGame(int timer, GameObjectsController goc) {
    	for(Zombie zb: goc.getZombies()) {
    		if(goc.getLawnMowers().isEmpty() && goc.getZombies().indexOf(zb) == 0 && timer%5 == 0) {

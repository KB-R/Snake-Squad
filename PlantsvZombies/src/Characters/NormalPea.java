...
public class NormalPea extends NPC implements Movable{
	...
	/**
	 * The constructor of the normal pea
	 * @param nX The new x co-ordinate fo the normal pea.
	 * @param nY The new x co-ordinate fo the normal pea.
	 * @param timeSpawned When the normal pea was shot from a pea shooter.
	 */
